...
const chaptersData = [
  ...
  },
  {
    ...
    mediaSrc: "/photo-placeholder.jpg",
    accent: "#fbbf24",
    alt: "Марина Морозова — учредитель АНБО Светлый, предприниматель из Рыбинска"
  },
  {
    id: "5",
    ...
    mediaSrc: "/photo-placeholder.jpg",
    accent: "#e879a0",
    alt: "Светлана Клюкина — учредитель АНБО Светлый, адвокат из Ярославля"
  },
  {
    id: "6",
    nav: "Андрей Синицын",
    ...
    mediaSrc: "/photo-placeholder.jpg",
    accent: "#34d399",
    alt: "Андрей Синицын — учредитель АНБО Светлый, предприниматель из Ярославля"
  },
  {
    id: "7",
    nav: "Наши результаты",
      ...
      <div className="relative lg:grid lg:grid-cols-2 lg:items-start">
        ...
        <div className="relative z-10 lg:z-[2]">
          ...
          <article ref={setRef(3)} className="relative px-6 py-16 sm:px-10 lg:px-[8vw] lg:py-[12vh] flex flex-col justify-center min-h-[50vh] lg:min-h-screen bg-paper transition-colors duration-800 rounded-none m-0 js-pd-chapter" data-chapter="4">
            ...
            <Reveal>
              <blockquote className="font-serif italic text-lg sm:text-xl lg:text-2xl font-[500] leading-relaxed text-foreground mb-7 pl-5 border-l-3 border-amber text-balance">
                <p>«Помогать животным — это зов сердца. Когда очередной подопечный обретает семью, понимаешь, ради чего мы всё это делаем.»</p>
              </blockquote>
            </Reveal>
            <Reveal>
              <p className="text-sm sm:text-base leading-relaxed mb-4.5 max-w-[52ch] text-foreground/80">
                Предприниматель из Рыбинска Ярославской области. Человек с большим сердцем, который очень любит животных и занимается благотворительностью в сфере зоозащиты.
              </p>
            </Reveal>
          </article>
          ...
          <article ref={setRef(4)} className="relative px-6 py-16 sm:px-10 lg:px-[8vw] lg:py-[12vh] flex flex-col justify-center min-h-[50vh] lg:min-h-screen bg-white rounded-[3rem_3rem_0_0] lg:rounded-none transition-colors duration-800 rounded-none m-0 js-pd-chapter" data-chapter="5">
            ...
            <Reveal>
              <blockquote className="font-serif italic text-lg sm:text-xl lg:text-2xl font-[500] leading-relaxed text-foreground mb-7 pl-5 border-l-3 border-amber text-balance">
                <p>«У бездомного животного нет голоса, чтобы защитить себя. Быть этим голосом — и есть наша работа.»</p>
              </blockquote>
            </Reveal>
            <Reveal>
              <p className="text-sm sm:text-base leading-relaxed mb-4.5 max-w-[52ch] text-foreground/80">
                Адвокат из Ярославля. Много лет помогает бездомным и оказавшимся в беде животным — на её счету немало спасённых кошачьих и собачьих судеб. Часть подопечных нашла новый дом, а часть продолжает оставаться под кураторством Светланы.
              </p>
            </Reveal>
          </article>
          ...
          <article ref={setRef(5)} className="relative px-6 py-16 sm:px-10 lg:px-[8vw] lg:py-[12vh] flex flex-col justify-center min-h-[50vh] lg:min-h-screen bg-paper transition-colors duration-800 rounded-none m-0 js-pd-chapter" data-chapter="6">
            ...
            <Reveal>
              <p className="text-sm sm:text-base leading-relaxed mb-4.5 max-w-[52ch] text-foreground/80">
                Предприниматель из Ярославля. Совершенно непубличный человек и крепкий хозяйственник, который помогает «Светлому» с материально-техническим обеспечением.
              </p>
            </Reveal>
          </article>
          ...
          <article ref={setRef(7)} className="relative px-6 py-16 sm:px-10 lg:px-[8vw] lg:py-[12vh] flex flex-col justify-center min-h-[50vh] lg:min-h-screen bg-paper rounded-[3rem_3rem_0_0] lg:rounded-none transition-colors duration-800 rounded-none m-0 js-pd-chapter" data-chapter="8">
            ...
            <Reveal>
              <p className="text-sm sm:text-base leading-relaxed mb-4.5 max-w-[52ch] text-foreground/80">
                В команде «Светлого» есть прекрасные волонтёры, которым мы бесконечно благодарны за безвозмездную помощь: прогулки с собаками, автоперевозки животных, фотосессии, распространение информации и многое другое. Мы всегда рады и открыты новым людям — ждём всех, кто хочет и готов помогать животным!
              </p>
            </Reveal>
            <Reveal>
              <VolunteerBento />
