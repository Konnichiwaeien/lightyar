      ...
      <div className="reports-wrap reports-dynamics-inner">
        <div className="reports-dynamics-data">
          ...
          <p className="reports-dynamics-note">
            Приют работает с октября 2024 года. Собак приносят и подбирают на улице круглый год, поэтому первая линия
            скачет. Дом ищется дольше, поэтому вторая поднимается медленнее.
          </p>
        </div>
